...
urlpatterns = [
    ...
    path('rebuild/<int:id>/download/', views.DownloadRebuiltCVView.as_view(), name='download-rebuilt-cv'),
    path('create/', views.CreateCVView.as_view(), name='create-cv'),
    path('create/<int:id>/download/', views.DownloadCreatedCVView.as_view(), name='download-created-cv'),
